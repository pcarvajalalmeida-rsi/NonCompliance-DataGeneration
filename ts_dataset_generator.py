...
def generate_random_id(n: int = 8, seed: int =1, rng=None):
    ...
    Arg:
    n: int. Indicates the number of numbers to include in the ID. For example 11111 would be generated by an n=5
    """
    start = 10 ** (n - 1)
    end = (10 ** n) - 1
...
class gen_rand_periods():
    ...
    def generate_periods(self, end:str, n:int, freq:str):
        """
...
class gen_ts_dataset():
    ...
    def get_dataset(self) -> pd.DataFrame:
        ...
        if self.export_csv: self.dataset_df.to_csv('./outputs/new_dataset.csv')
